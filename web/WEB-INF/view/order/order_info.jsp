...
<html>
	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
					<tr>
						...
						<td valign="top">
							${map.value.product.productName }
						</td>
						<td valign="top">
							${map.value.product.dangPrice }
						</td>
						<td valign="top">
							${map.value.num }
						</td>
						<td valign="top">
							${map.value.product.dangPrice*map.value.num }
						</td>
					</tr>
			...
			<br />
			<div class="login_in">
				<a href="${pageContext.request.contextPath}/car.do?method=4"><input id="btnClientRegist" class="button_1" name="submit"
