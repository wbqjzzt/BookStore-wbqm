...
<html>
	...
	<body>
		...
		<form action="register.do?method=2" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<a href="${pageContext.request.contextPath}/emailcode.jsp" target="_blank" >
                            <span class="red"><span id="lblEmail">${s_user.email }</span></span></a>
						<span class="t1"> 
						请登录您的邮箱收信。
						</span>
					</div>
