					...
					<tr class='objhide' over="no">
                      ...
                      <c:forEach items="${s_car }" var="map">
						<tr class='td_no_bord'>
							...
							<td>
							<a href="${pageContext.request.contextPath}/main.do?id=${map.value.pro.id }&method=1">${map.value.pro.productName }</a>
							</td>
							<td>
								<a href="${pageContext.request.contextPath}/main.do?id=${map.value.pro.id }&method=1"><IMG id=img_show_prd
										src="${pageContext.request.contextPath}/productImages/${map.value.pro.productPic }" width="75px"></td>
							<td class="buy_td_5">
								<span class="c_gray">${map.value.pro.fixedPrice}</span>
							</td>
							<td class="buy_td_4">
								&nbsp;&nbsp;
								<span>￥${map.value.pro.dangPrice}</span>
							</td>
							...
							<td >
								...
								<a href="car.do?id=${map.value.pro.id }&method=2&num=">变更</a>
							</td>
							<td>
								<a href="car.do?id=${map.value.pro.id }&method=1">删除</a>
							</td>
						</tr>
						</c:forEach>
					<!-- 购物列表结束 -->
				...
				<tbody>
					...
					<tr>
						...
						<td width="365" class=t2>
							<a href="#">${cDel.pro.productName }</a>
						</td>
						<td width="106" class=buy_td_5>
							￥${cDel.pro.fixedPrice }
						</td>
						<td width="134" class=buy_td_4>
							<span>￥${cDel.pro.dangPrice }</span>
						</td>
