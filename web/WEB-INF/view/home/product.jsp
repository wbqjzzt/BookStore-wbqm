					...
					<DIV class=right_wai>
						<DIV class=shuming>
							<DIV class=shuming_left>
								...
								<SPAN class=black000><A name=top_bk></A>${book.productName }</SPAN>
							</DIV>
							<DIV class=book_case>
								<SPAN class=seriesname>丛书名： ${book.productName }</SPAN>
							</DIV>
						...
						<DIV class=book_left>
							<DIV class=book_pic>
								<IMG id=img_show_prd
										src="${pageContext.request.contextPath}/productImages/${book.productPicture }">
								</A>
							</DIV>
						...
						<DIV class=book_right>
							...
							<DIV class=jiage>
								<SPAN class=gray87>定价：<SPAN class=del id=originalPriceTag>￥${book.fixedPrice
										}</SPAN>
								</SPAN>
								<SPAN class=redc30>淘书斋价：￥<B>${book.dangPrice }</B>
							...
							<a href="<%=request.getContextPath() %>/car.do?method=0&id=${book.id }"> 
...
-->
						...
						<DIV id=__zhinengbiaozhu_bk>
							...
							<DIV class=zhengwen>
								${book.author} ${book.authorSummary }
							</DIV>
							<DIV class=dashed></DIV>
							<H2 class=black14>
